package com.sd.Monitoring.Communication.security.config;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.sd.Monitoring.Communication.exception.AccessDeniedHandlerBean;
import com.sd.Monitoring.Communication.security.filter.AuthorizationFilter;
import com.sd.Monitoring.Communication.security.util.SecurityConstants;
    ...
    public SecurityFilterChain filterChain(
        ...
        return http
                ...
                .authorizeHttpRequests((authorize) -> authorize
                        ...
                        .requestMatchers("/api/measurements/consumption/**").permitAll()
